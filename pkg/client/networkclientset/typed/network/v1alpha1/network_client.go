...
import (
	...
	"github.com/edgefarm/anck/pkg/client/networkclientset/scheme"
...
type NetworkV1alpha1Interface interface {
	...
	NetworksGetter
	ParticipantsesGetter
}

// NetworkV1alpha1Client is used to interact with features provided by the network group.
...
func (c *NetworkV1alpha1Client) Participantses(namespace string) ParticipantsInterface {
	return newParticipantses(c, namespace)
}
